const TimelineItem = ({ timeline: { title, meta, text, year } }) => {
    return (
        <div className="timeline relative block items-start rounded-full border-white border-opacity-20 first:mt-0 md:flex">
            <span className="timeline-year absolute top-0 left-12 mt-7 mr-12 min-w-[130px] rounded-full bg-primary bg-opacity-10 p-2 text-center text-base leading-none md:relative md:left-0">
                {year}
            </span>
